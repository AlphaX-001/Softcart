<?php
	...
	if(!isset($_SESSION["isLoggedIn"]))
	{
		...
		?>
			<html>
				<head>		
					<title>Login | SoftCart - an E-Commerce Platform</title>
			...
			*:after {
			...
			<?php
						...
						echo "
							<center>
								<div class='alert'>
								  ...
								  <strong>No Need</strong> Already Logged in.
				...
				if(isset($_COOKIE["hasErrorLogin"]))
				{
					if($_COOKIE["hasErrorLogin"]=="true")
					{
						echo "
							<center>
								<div class='alert'>
				...
				if(isset($_COOKIE["hasErrorSignUp"]))
				{
					if($_COOKIE["hasErrorSignUp"]=="true")
					{
						echo "
							<center>
								<div class='alert'>
								  <span class='closebtn' onclick='this.parentElement.style.display=`none`;'>&times;</span> 
								  <strong>Email already exist!</strong> Try Logging in.
								</div>
							</center>
						";
					}
			...
			?>
				...
				<form action="./login-action.php" method="get">
					...
					<div class="sub-cont">
						...
						<form action="./signup-action.php" method="get">
