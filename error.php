<html>
	<head>
		<title>Error | SoftCart - an E-Commerce Platform</title>
	...
	<body>
			...
			<br>
				...
				<br>
				<br>
				<h1 style="color:red">OOPS!! you should'nt be in this Page. <a href="./index.php"><u>Click here</u> </a>to go to Home Page.</h1>
			</center>
	</body>
</html>
